...
public interface IUniDAManagementFacade
{
	...
	IDevice addNewDevice(IDevice dev) throws InternalErrorException;
        ...
        /** Adds a new device to the DAL, associating it to a device IO of a
         * gateway
	 * @param dev The device to add
	 */
	 ...
	 * @return The group with its new member
	 */
	 ...
	 * @return The group without the device
	 */
	...
	/** Gets all the devices managed by the DAL by using indexes to
         * navigate the device collection.
         *
	...
	/** Gets all the devices managed by the DAL that aren't configured
         * yet by using indexes to navigate the device collection.
         *
	 * @param startIndex First device to retrieve
	 * @param length Number of devices to retrieve
	 * @return the devices found
	...
	/** Gets the devices managed by the DAL that are at the especified
         * location by using indexes to navigate the device collection.
         *
	 * @param startIndex First device to retrieve
	 * @param length Number of devices to retrieve
	...
	Collection<IDevice> findByFunctionality(int startIndex, int length, ControlFunctionalityMetadata functionality)  throws InternalErrorException;
        ...
        /** Associates a previously created device with a device IO in a
         * device gateway. In case that the device is moved from another IO,
         * the source IO is disconnected from it.
         *
         * If 'deleteDestionation' is false, in case that the destination
         * IO has a previously associated device, it is changed to not-enabled
         * state, otherwise it is deleted.
         *
         * @param device
         * @param deviceIO
         * @throws InstanceNotFoundException
         ...
         * gateway was not previously known, it creates a new gateway and its associated
         * devices. If it was known, it updates the gateway and its devices.
         *
         * @param devGw
         * @return
         * @throws InternalErrorException
        ...
        /** Marks a device gateway and its associated devices as been lost because
         * we are not receiving the periodic annoucement messages from the gateway.
         *
         * @param devGw
         * @throws InternalErrorException
         */
        ...
        /** Retrieves the device gateways that have the indicated location and its associated devices
         *
         * @param startIndex
         * @param lenght
         * @param lcoation
        ...
        /** Retrieves the device that have the indicated location and its devices gateways
         *
         * @param startIndex
         * @param lenght
         * @param lcoation
