 ...
 * @version 1
 */
public class GatewayDevices implements Serializable
{
    ...
    public GatewayDevices(Gateway deviceGateway, Collection<IDevice> devices)
    {
        this.deviceGateway = deviceGateway;
        this.devices = new ArrayList<>(devices);
    }

    public Gateway getDeviceGateway()
    {
