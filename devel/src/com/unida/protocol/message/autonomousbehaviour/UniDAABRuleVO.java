...
public class UniDAABRuleVO {
            ...
            IUniDAOntologyCodec ontologyCodec) throws MessageFormatException
    {
        ...
        if (null != this.trigger) this.trigger.decodePayload(bytes, initIndex, ontologyCodec);
        ...
        if (null != this.action) initIndex = this.action.decodePayload(bytes, initIndex, ontologyCodec);
